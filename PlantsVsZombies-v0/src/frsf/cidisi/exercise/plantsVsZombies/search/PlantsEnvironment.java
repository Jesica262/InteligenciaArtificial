...
public class PlantsEnvironment extends Environment {
    ...
    public Perception getPercept() {
        ...
        // perception
        int row = this.getEnvironmentState().getPosicionAgenteX();
        int col = this.getEnvironmentState().getPosicionAgenteY();
    ...
    public boolean agentFailed(Action actionReturned) {
        ...
        int agenteSoles = plantsEnvironmentState.getAgentSoles();
